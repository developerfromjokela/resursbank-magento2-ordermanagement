...
interface CallbackInterface
{
     ...
     */
    public function unfreeze(string $orderIncId, string $digest): void;
     ...
     * @throws WebapiException
     */
    public function booked(string $orderIncId, string $digest): void;
     ...
     * @throws WebapiException
     */
    public function update(string $orderIncId, string $digest): void;
